...
import net.stohun.corners.block.CornerBlock;

import java.util.concurrent.CompletableFuture;

public class CornersLootTableProvider extends FabricBlockLootTableProvider {
    public CornersLootTableProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
    ...
    public void generate() {
        ...
        addCornerDrop(ModBlocks.OAK_CORNER, cornerProperties);
        addCornerDrop(ModBlocks.SPRUCE_CORNER, cornerProperties);
        addCornerDrop(ModBlocks.BIRCH_CORNER, cornerProperties);
        addCornerDrop(ModBlocks.JUNGLE_CORNER, cornerProperties);
        addCornerDrop(ModBlocks.ACACIA_CORNER, cornerProperties);
        addCornerDrop(ModBlocks.DARK_OAK_CORNER, cornerProperties);
