...
public class CornersModelProvider extends FabricModelProvider {
    ...
    private static final MaterialConfig[] MATERIALS = {
            ...
            new MaterialConfig("bamboo_mosaic", Blocks.BAMBOO_MOSAIC, ModBlocks.BAMBOO_MOSAIC_CORNER),
            ...
            new MaterialConfig("stone_brick", Blocks.STONE_BRICKS, ModBlocks.STONE_BRICK_CORNER),
            new MaterialConfig("mossy_stone_brick", Blocks.MOSSY_STONE_BRICKS, ModBlocks.MOSSY_STONE_BRICK_CORNER),
            new MaterialConfig("granite", Blocks.GRANITE, ModBlocks.GRANITE_CORNER),
            new MaterialConfig("polished_granite", Blocks.POLISHED_GRANITE, ModBlocks.POLISHED_GRANITE_CORNER),
            new MaterialConfig("diorite", Blocks.DIORITE, ModBlocks.DIORITE_CORNER),
            new MaterialConfig("polished_diorite", Blocks.POLISHED_DIORITE, ModBlocks.POLISHED_DIORITE_CORNER),
            new MaterialConfig("andesite", Blocks.ANDESITE, ModBlocks.ANDESITE_CORNER),
            new MaterialConfig("polished_andesite", Blocks.POLISHED_ANDESITE, ModBlocks.POLISHED_ANDESITE_CORNER),
            new MaterialConfig("cobbled_deepslate", Blocks.COBBLED_DEEPSLATE, ModBlocks.COBBLED_DEEPSLATE_CORNER),
            new MaterialConfig("polished_deepslate", Blocks.POLISHED_DEEPSLATE, ModBlocks.POLISHED_DEEPSLATE_CORNER),
            new MaterialConfig("deepslate_brick", Blocks.DEEPSLATE_BRICKS, ModBlocks.DEEPSLATE_BRICK_CORNER),
            new MaterialConfig("deepslate_tile", Blocks.DEEPSLATE_TILES, ModBlocks.DEEPSLATE_TILE_CORNER),
            new MaterialConfig("tuff", Blocks.TUFF, ModBlocks.TUFF_CORNER),
            new MaterialConfig("polished_tuff", Blocks.POLISHED_TUFF, ModBlocks.POLISHED_TUFF_CORNER),
